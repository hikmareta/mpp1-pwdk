      ...
      <>
          <section className="bg-white pt-32">
            <div className="container mx-auto px-5 text-center">
                ...
                <p className="w-full lg:w-[40%] text-black mx-auto mb-6 lg:mb-10">Temukan event-event teknologi terbaru di kategori kami. Jelajahi beragam topik seperti pemrograman, kecerdasan buatan, dan sains data. Sambut inovasi bersama kami.</p>
