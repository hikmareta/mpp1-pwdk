                ...
                <div className="flex flex-wrap md:grid md:grid-cols-2 lg:grid-cols-4 gap-10 justify-center">
                    <div className="rounded-xl w-full h-full shadow-lg hover:shadow-2xl">
                        ...
                        <div className="px-6 pb-8">
                            ...
                            <p className="text-slate-600 mb-3 line-clamp-2 hover:line-clamp-none">Di sini deskripsi acara Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sint, distinctio. Recusandae iste in velit corporis dignissimos est, officia sapiente tempora!</p>
                            <div className="flex flex-wrap">
                                <img src="" alt="" />
                                <p className="text-slate-600 font-semibold mb-3">30 Februari 2022</p>
                            </div>
